...
to_sparse_matrix(T, A::Number) = convert(SparseMatrixCSC{T,Int64}, fill(A,1,1))
to_sparse_matrix(T, A::AbstractVector) = convert(SparseMatrixCSC{T,Int64}, reshape(A,:,1))
to_sparse_matrix(T, A::AbstractMatrix) = convert(SparseMatrixCSC{T,Int64}, A)
